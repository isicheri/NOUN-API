...
export class NotificationController {
  ...
  async getAdminNotificaton(@Req() request: AuthRequest) {
    ...
    const notifications =
      await this.usersService.getNotificationsForAdmin(adminId);
  ...
  async getAdmingNotificationById(
    ...
    return await this.notificationService.getAdmingNotificationById(
      id,
      request.user.userId,
    );
  }
